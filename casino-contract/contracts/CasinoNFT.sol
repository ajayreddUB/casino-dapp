...
contract CasinoNFT is ERC721URIStorage {
    ...
    constructor(address initialOwner) ERC721("CasinoNFT", "CNFT") {
        owner = initialOwner;
        tokenCounter = 2;
        mintNFT(initialOwner, "https://ipfs.io/ipfs/QmWxS5RZbnGVVTCWmCCFXpyfAFwRJXGAuph8rxd7V5m8Mf");
        mintNFT(initialOwner, "https://ipfs.io/ipfs/QmSArxHhC5vkVKB1ijAauKhb2e4BU2HuLdHkGsowbxq6Tr");
    }
    modifier onlyOwner() {
